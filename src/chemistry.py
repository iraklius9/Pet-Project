...
def substructure_search(molecules: list[str], substructure: str):
    if not substructure:
        return []

    return _substructure_search_rdkit(molecules, substructure)


def _substructure_search_rdkit(molecules: list[str], substructure: str):
